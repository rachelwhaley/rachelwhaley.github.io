...
---
## How to think about using AI tools while learning Excel/SQL/Python
...
1. Always make sure you understand the formula/code it wrote​
    * Can you explain it in your own words?​
2. Always try the formula/code yourself and gut-check the results ​
